 ...
 */
@Extension
public class NettyDockerJavaConnector extends DockerJavaConnector {
    @DataBoundConstructor
    public NettyDockerJavaConnector(String serverUrl) {
        super(serverUrl);
    }
    ...
    public DockerClient getClient() {
        if (client == null) {
            try {
                client = newClientBuilderForConnector(new NettyDockerCmdExecFactory())
    ...
    public static class DescriptorImpl extends DockerJavaConnectorDescriptor {
        ...
        public FormValidation doTestConnection(
            ...
            try {
                ...
                final DockerClient testClient = newClientBuilderForConnector(new NettyDockerCmdExecFactory())
